...
module.exports = {
    ...
    work(message, callback, user) {
        ...
        if (!user.inv.hasOwnProperty("laptop") || !user.inv.hasOwnProperty("headset")) {
            ...
            const categories = ["Among Us", "cat", "Minecraft", "makeup", "coding", "counting to 10", "nursery rhyme", "advertising coder gautam", "tech review", "boring", "hacking", "Peepy Llama bot fan"]
            const embed = new Discord.MessageEmbed();
            embed.setColor('#5d369d')
            ...
            if (num == 1 || num == 2) {
                ...
                var subsGained = (user.youtube.subs > 100000 ? getRandomInt(10, 1000) : getRandomInt(50, 5000))
                user.youtube.subs += subsGained
